...
public class GamePlay
{
    public static void play(Game game, Scanner scanner)
    {
        ...
        if (min == max)
        {
            if (min == 1)
            {
                System.out.println("Das Spiel ist fuer eine einzige Person.");
            }
            else
            {
                System.out.println("Es muessen genau " + min + " Personen teilnehmen.");
            }
            players = min;
        }
        else
        {
            ...
            {
                System.out.println("Am Spiel koennen zwischen " + min + " und " + max + " Personen teilnehmen.");
        ...
        {
            System.out.println("Eine Ausnahme zur fehlenden Initialisierung fuer die erste Anzeige des Spielbretts h�tte nicht passieren d�rfen.");
            return;
        }
        try
        {
            ...
            if (players == 1)
            {
                if (game.hasWinner())
                {
                    System.out.println("Die einzige spielende Person hat gewonnen. Glueckwunsch!");
                }
                else
                {
            ...
            else // players > 1
            {
                if (game.hasWinner())
                {
                    ...
                    System.out.println("Person Nr. " + winner + " hat gewonnen. Glueckwunsch!");
                }
                else
                {
