...
public class RomanNumeralFormat1
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            System.out.println("Roman: " + RomanNumeralFormat1.toString(i)); // MMMCMXCIX
            System.out.println("Arabic: " + RomanNumeralFormat1.parse(toString(i)));
        }
